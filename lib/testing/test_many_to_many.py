...
def test_contract_contracts_by_date():
    """Test Contract class has method contracts_by_date() that filters contracts by date in insertion order"""
    Contract.all_contracts = []  # Reset contracts list properly
    ...
    # Ensure contracts are returned in the correct order
